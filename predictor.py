...
class DepthEstimationModel:
    ...
    def _initialize_model(self,model_repo="isl-org/ZoeDepth",model_Name="ZoeD_N"): #it will work automaticaly when the class is called it will download and returned
